  ...
  return (
    <div className=" cursor-pointer ">
      <div className="flex justify-center mb-16">
        <h1 className=" bg-gradient-to-r from-green-300 via-blue-400 to-purple-500 bg-clip-text text-2xl tracking-tight font-thin text-transparent ">
          {" "}
          View Full Resume
        </h1>
      </div>
            ...
            >
              <div className="flex flex-wrap flex-row justify-between items-center py-4">
                ...
                <div className=" size-30 flex items-center ">
                  <img
                    src={experience.c_Logo}
                    alt=""
                    className="bg-slate-50 rounded p-2 h-auto"
                    width="100"
                    height="100"
                  />
                </div>
              ...
              <div className="flex flex-wrap">
                {experience.technologies.map((tech, index) => (
                  <span
                    key={index}
                    className="m-2 rounded-md bg-slate-700 px-3 py-0.5 text-sm font-medium text-green-300"
                  >
                    {tech}
                  </span>
                ))}
